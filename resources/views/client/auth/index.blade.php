...
<head>
    ...
    <title>Dashboard Pelanggan Urbanet</title>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-center h-px-500">
                                    <form class="w-px-400 border rounded p-3 p-md-5" method="POST" action="{{ route('client.auth.step1.submit') }}">
                                        ...
                                        <div class="mb-6">
                                            <label class="form-label" for="form-alignment-username">NoPel/WA Pelanggan</label>
                                            <input type="text" name="no_hp" id="no_hp" class="form-control" required placeholder="0812xxxxxxx">
                                        </div>
