...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('partner.dashboard.*') ? 'active open' : '' }}">
            <a href="{{ route('partner.dashboard') }}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-smart-home"></i>
                <div data-i18n="Dashboard">Dashboard</div>
            </a>
        </li>
        <li class="menu-item {{ request()->routeIs('partner.transaksi.*') ? 'active open' : '' }}">
            <a href="{{ route('partner.transaksi') }}" class="menu-link">
