                        ...
                        <div class="col-md-6 col-xxl-4 mb-6">
                            ...
                            <div class="card h-100">
                                <div class="card-header header-elements">
                                    <h5 class="mb-0 me-2">Daftar Pelanggan</h5>
                                    @if($referrals->isNotEmpty())
                                    <div class="card-header-elements ms-auto">
                                        <a href="{{ route('add_client.create') }}" class="btn btn-xs btn-primary waves-effect waves-light">
                                            <span class="tf-icon ti ti-plus ti-xs me-1"></span>Tambah Pelanggan</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        @empty
                                        <li class="list-group-item text-muted">Belum ada client yang didaftarkan.</li>
                                        @endforelse
                                    </ul>
                                    @else
