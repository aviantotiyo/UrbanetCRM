                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="mb-1">
                                    <span class="h5">Edit Data Kategori Barang</span>
                                </div>

                            </div>
                            <div class="d-flex align-content-center flex-wrap gap-2">
                                <!-- <button class="btn btn-label-primary">Tambah Pelanggan</button> -->
                                <a href="{{ route('admin.warehouse_category.index') }}" class="btn btn-outline-primary">← Kembali</a>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.warehouse_category.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row g-6">
                                <div class="col-md-6">
                                    <div class="card">
                                        <h5 class="card-header">Edit Kategori Barang</h5>
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label for="kode_kategori" class="form-label">Kode Kategori</label>
                                                <input type="text" class="form-control" name="kode_kategori" value="{{ $kategori->kode_kategori }}" readonly>
                                            </div>
