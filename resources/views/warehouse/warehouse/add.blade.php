@section('title', 'Tambah Data Warehouse')
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="mb-1">
                                    <span class="h5">Tambah Data Lokasi Gudang</span>
                                </div>
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.dashboard_warehouse.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-6">
                                <div class="col-md-6">
                                    <div class="card">
