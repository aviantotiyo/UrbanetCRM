@section('title', 'Data Lokasi Gudang')
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="mb-1">
                                    <span class="h5">Lokasi Gudang</span>
                                </div>

                            </div>
                            <div class="d-flex align-content-center flex-wrap gap-2">
                                <!-- <button class="btn btn-label-primary">Tambah Pelanggan</button> -->
                                <a href="{{ route('admin.dashboard_warehouse.create') }}" class="btn btn-outline-primary">Tambah Data</a>
                            </div>
                        </div>
                        {{-- Alert sukses --}}
                        @if (session('success'))
                        ...
                        <div class="card">
                            <h5 class="card-header">Data Lokasi Gudang</h5>
                                            ...
                                            <td>
                                                <div class="d-flex flex-wrap align-items-center mb-50">
                                                    <div>
                                                        ...
                                                        <small>{{ $gudang->kode_gudang ?? '-' }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $gudang->lokasi ?? '-' }}</td>
