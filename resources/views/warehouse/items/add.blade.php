@section('title', 'Tambah Data Item Barang')
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="mb-1">
                                    <span class="h5">Tambah Data Item Barang</span>
                                </div>
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.warehouse_items.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-6">
                                <div class="col-md-6">
                                    <div class="card">
                                        <h5 class="card-header">Buat Data Item Barang</h5>
                                        <div class="card-body">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="unit_type" class="form-select" required>
                                                    ...
                                                    <option value="{{ $unit }}" {{ old('unit_type') == $unit ? 'selected' : '' }}>{{ ucfirst($unit) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
