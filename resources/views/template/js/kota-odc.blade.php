...
function renderOptions($select, items, nameKey = 'name', idKey = 'id', placeholder = '-- pilih --', selectedValue = '') {
    $select.innerHTML = '';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function onProvChange(selectKab = true) {
        ...
        renderOptions(kab, filteredKab, 'name', 'id', '-- pilih kabupaten/kota --', oldKab);
    ...
    function onKabChange(selectKec = false) {
        ...
        renderOptions(kec, filteredKec, 'name', 'id', '-- pilih kecamatan --', oldKec);
