<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('admin.komisi_sales.*', 'admin.komisi_teknisi.*', 'admin.komisi_mitra.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('admin.komisi_teknisi.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.komisi_teknisi.index') }}" class="menu-link">
        ...
        <li class="menu-item  {{ request()->routeIs('admin.warehouse_category.*', 'admin.warehouse_items.*' ) ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('admin.warehouse_items.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.warehouse_items.index') }}" class="menu-link">
