...
<head>
    <meta charset="utf-8">
    <title>Tambah Port ODC — UrbanetCRM</title>
...
<body class="bg-light">
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h5 mb-0">Tambah Port — ODC {{ $odc->kode_odc }}</h1>
            <a href="{{ route('admin.odc.show', $odc->id) }}" class="btn btn-sm btn-outline-secondary">← Kembali</a>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="mb-3 small">
                    <div>ODC: <span class="fw-semibold">{{ $odc->kode_odc }}</span> — {{ $odc->nama_odc ?: '—' }}</div>
                </div>
