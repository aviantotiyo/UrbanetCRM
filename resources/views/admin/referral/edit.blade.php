                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex align-content-center flex-wrap gap-2">
                                ...
                                <a href="{{ route('admin.referral.index') }}" class="btn btn-outline-primary">← Kembali</a>
                            </div>
                        </div>
                        ...
                        <form id="client-edit-form" method="POST" action="{{ route('admin.referral.update', $prospect->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <a href="{{ route('admin.referral.index') }}" class="btn btn-outline-secondary">Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
