@section('title', 'Edit Data Server (POP)')
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="mb-1">
                                    <span class="h5">Edit Data Server (POP)</span>
                                </div>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.server.update', $server->id) }}" novalidate>
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input name="nama_pop" class="form-control @error('nama_pop') is-invalid @enderror"
                                                value="{{ old('nama_pop', $server->nama_pop) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                                                value="{{ old('lokasi', $server->lokasi) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="ip_static" class="form-control @error('ip_static') is-invalid @enderror"
                                                value="{{ old('ip_static', $server->ip_static) }}">
