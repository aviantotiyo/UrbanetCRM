                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="mb-4">
                        ...
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                          value="{{ old('nama', $client->nama) }}" required data-titlecase>
                      ...
                      <div class="mb-4">
                        ...
                        <input id="nik" name="nik" type="text" class="form-control @error('nik') is-invalid @enderror"
                          value="{{ old('nik', $client->nik) }}" placeholder="____.____.____.____">
                      ...
                      <div class="mb-4">
                        ...
                        <input id="no_hp" name="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror"
                          value="{{ old('no_hp', $client->no_hp) }}" placeholder="628xxxxxxxxxx">
                      ...
                      <div class="mb-4">
                        ...
                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                          value="{{ old('email', $client->email) }}" placeholder="email@domain.com">
                      ...
                      <div class="mb-4">
                        ...
                        <select id="paket" name="paket" class="form-select @error('paket') is-invalid @enderror">
                          ...
                          @foreach($pakets as $p)
                          <option value="{{ $p->nama_paket }}" {{ old('paket', $client->paket) === $p->nama_paket ? 'selected' : '' }}>
                            {{ $p->nama_paket }}
                          </option>
                          @endforeach
                        </select>
                        @error('paket')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <div class="form-text">Pilih paket dari master paket.</div>
                      </div>

                      <div class="mb-3">
                        <label class="form-label">Tagihan</label>
                        <input id="tagihan" name="tagihan" type="text" class="form-control @error('tagihan') is-invalid @enderror"
                          value="{{ old('tagihan', $client->tagihan) }}" placeholder="250000" readonly disabled>
                      ...
                      <div class="mb-3">
                        ...
                        <input id="name_profile" name="name_profile" type="text" class="form-control @error('name_profile') is-invalid @enderror"
                          value="{{ old('name_profile', $client->name_profile) }}" placeholder="home-20m / biz-50m" readonly disabled>
                      ...
                      <div class="mb-4">
                        ...
                        <input id="limit_radius" name="limit_radius" type="text" class="form-control @error('limit_radius') is-invalid @enderror"
                          value="{{ old('limit_radius', $client->limit_radius) }}" placeholder="512k/512k" readonly disabled>
                    ...
                    <div class="card-footer d-flex gap-2">
                      ...
                      <a href="{{ route('admin.pelanggan.show', $client->id) }}" class="btn btn-outline-secondary">Batal</a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="mb-4">
                        ...
                        <input name="loc_client" type="text" class="form-control @error('loc_client') is-invalid @enderror"
                          value="{{ old('loc_client', $client->loc_client) }}" placeholder="https://maps.app.goo.gl/...">
                      ...
                      <div class="mb-4">
                        ...
                        <select id="provinsi_pel" name="provinsi" class="form-select @error('provinsi') is-invalid @enderror">
                          ...
                          <option value="{{ $p['name'] ?? '' }}" data-id="{{ $p['id'] ?? '' }}"
                            {{ old('provinsi', $client->provinsi) === ($p['name'] ?? '') ? 'selected' : '' }}>
                            {{ $p['name'] ?? '' }}
                          </option>
                          @endforeach
                        </select>
                      ...
                      <div class="mb-4">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                          ...
                          <option value="{{ $s }}" {{ old('status', $client->status) === $s ? 'selected' : '' }}>{{ $s }}</option>
                          @endforeach
                        </select>
                      ...
                      <div class="mb-4">
                        ...
                        <input name="tag" type="text" class="form-control @error('tag') is-invalid @enderror"
                          value="{{ old('tag', $client->tag) }}" placeholder="VIP, Corporate, Residential">
                      ...
                      <div class="mb-4">
                        ...
                        <textarea name="note" rows="3" class="form-control @error('note') is-invalid @enderror"
                          placeholder="Catatan tambahan...">{{ old('note', $client->note) }}</textarea>
