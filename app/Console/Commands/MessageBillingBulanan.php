...
// Kirim pesan ketika tagihan mendepati tanggal jatuh tempo
// pengingat pertama
...
use App\Jobs\JobMessageBillingBulanan;
use Carbon\Carbon;

class MessageBillingBulanan extends Command
{
    protected $signature = 'billing:message-reminder';
    ...
    public function handle()
    {
        ...
        foreach ($billings as $billing) {
            JobMessageBillingBulanan::dispatch($billing->id);
